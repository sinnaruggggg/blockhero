...
comment on table public.ui_assets is
  'UI image/audio assets used by visual config. Audio assets are stored as data:audio/* base64 URLs and referenced from config_json.gameplay.audio.';
